...
const blocks = [
  ...
  },
  {
    ...
    tagStyle: 'bg-charcoal-100 text-charcoal-700 border-charcoal-200',
    dotColor: 'bg-charcoal-500',
    iconBg: 'bg-charcoal-100',
    iconColor: 'text-charcoal-600',
    card: 'bg-white border-charcoal-100',
    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-8">
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
        ...
        <div
          ...
          :key="block.title"
          class="reveal rounded-2xl border p-7 lg:p-8 flex flex-col gap-5 hover:-translate-y-0.5 transition-all duration-300 shadow-sm hover:shadow-md items-center text-center"
          :class="block.card"
